...
1. Run `git status --porcelain` and `git diff HEAD -p` to survey all changes (staged and unstaged).
...
- Scope: optional, names a module, component, or issue; in parentheses → `feat(auth): ...` or `feat(#42): ...`
